...
myNormColor   = "#262626"                        -- Border color of unfocused windows.
...
-- Spawn programs keybindings.
     ...
     , ("M-o", spawn "exec ~/Documents/Obsidian-1.5.3.AppImage") -- Launches Obsidian.
     ...
     , ("<XF86AudioMute>", spawn "pulseaudio-ctl mute")   --Mute/Unmute Volume.
     , ("<XF86AudioMicMute>", spawn "pulseaudio-ctl mute-input")   --Mute/Unmute Mic.
     , ("<XF86Launch1>", spawn "nemo")           -- idk yet
